package src.com.university;
import java.time.LocalDate;
import java.util.List;
import java.util.Scanner;

import src.com.university.enums.*;
import src.com.university.exception.*;
import src.com.university.model.academic.*;
import src.com.university.model.research.*;
import src.com.university.model.user.*;
import src.com.university.pattern.*;
...
public class Main {
    ...
    static void demoProfessorView(Professor p) {
        ...
        p.printPapers(new src.com.university.comparator.PaperByCitationsComparator());
        System.out.println("\n─── Papers sorted by date ───");
        p.printPapers(new src.com.university.comparator.PaperByDateComparator());
    ...
    static void demoResearch(Professor prof) {
        ...
        Database.getInstance().getAllPapersSorted(
            new src.com.university.comparator.PaperByCitationsComparator())
